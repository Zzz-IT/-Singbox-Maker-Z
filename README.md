...
* **跨发行版兼容层**：自动识别 `systemd` 与 `openrc` 初始化系统，支持 Debian、Ubuntu、CentOS 及 Alpine Linux 等主流发行版。
...
### 节点菜单
<p align="left">
<img src="pic/创建节点.png" alt="Add Node Menu" width="396">
</p>

### 高级设置
<p align="left">
<img src="pic/高级设置.png" alt="Advanced Settings" width="380">
</p>
